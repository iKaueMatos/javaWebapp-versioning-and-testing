    ...
    <body class="bg-white  min-h-screen">
        ...
        <div class="container max-w-[1440px] mx-auto">
            ...
            <div class="services">
                ...
                <div class="cards flex justify-center gap-x-7 gap-y-10 flex-wrap text-black text-center">
                    ...
                    <div class="card w-[370px] px-7 py-10">
                        <img class="pb-5 mx-auto" src="./img/AgriculturaImg/ProdutosOrgÃ¢nicosverde.png" alt="Um alimento convecional e prejudicial para o ser humano?">
                    ...
                    <div class="card w-[370px] px-6 py-9">
                        <img class="pb-5 mx-auto" src="./img/AgriculturaImg/AgricultorFazenda.webp" alt="Qual e melhor para vocÃª alimento organico ou alimento convecional">
            ...
            <div class="description2 grid grid-cols-1 my-40 items-center lg:grid-cols-2 justify-evenly gap-10 px-[5%]">
                <div class="left col-span-1 text-black">
                    <h2 class="font-bold text-4xl  leading-[52px] lg:text-[42px]">Agricultura orgÃ¢nica VS convencional</h2>
                    <p class="font-normal my-8 text-base text-justify indent-8">A agricultura orgÃ¢nica e a convencional sÃ£o dois sistemas de produÃ§Ã£o agrÃ­cola com diferenÃ§as significativas em termos de prÃ¡ticas e impactos. Na agricultura convencional, os produtores utilizam agrotÃ³xicos, fertilizantes sintÃ©ticos
                        e sementes geneticamente modificadas para aumentar a produtividade das culturas. AlÃ©m disso, as monoculturas sÃ£o comuns nesse sistema, o que pode levar Ã  perda de biodiversidade e Ã  degradaÃ§Ã£o do solo. A agricultura convencional
                        tambÃ©m pode ter impactos negativos na saÃºde das pessoas e dos animais, devido ao uso excessivo de agrotÃ³xicos. Por outro lado, a agricultura orgÃ¢nica utiliza prÃ¡ticas sustentÃ¡veis e mÃ©todos naturais para aumentar a produtividade
                        das culturas. Os produtores orgÃ¢nicos nÃ£o usam agrotÃ³xicos sintÃ©ticos ou fertilizantes quÃ­micos, e geralmente usam tÃ©cnicas de compostagem, rotaÃ§Ã£o de culturas e uso de adubos orgÃ¢nicos para manter a fertilidade do solo. AlÃ©m disso,
                        a agricultura orgÃ¢nica incentiva a biodiversidade e a preservaÃ§Ã£o do meio ambiente. Os alimentos orgÃ¢nicos sÃ£o produzidos sem o uso de agrotÃ³xicos, o que os torna mais saudÃ¡veis e nutritivos. AlÃ©m disso, a agricultura orgÃ¢nica
                        pode contribuir para a criaÃ§Ã£o de empregos locais e para o fortalecimento da economia regional. Em resumo, a agricultura orgÃ¢nica e a convencional apresentam diferenÃ§as significativas em termos de prÃ¡ticas e impactos. A escolha
            ...
            <div class="team text-center my-40">
                ...
                <div class="cards flex justify-center gap-10 flex-wrap">
                    <div class="card w-[270px] py-8 px-14 text-black text-center">
                        ...
                        <p class="font-normal leading-5 uppercase">Cursando CiÃªncias da computaÃ§Ã£o </p>
            ...
            <div class="contact text-center my-10 mx-[5%]" id="Contato">
                <div class="container px-[5%] mx-auto flex flex-col max-w-[900px] w-full justify-center items-center text-black">
                    <form method="Post" action="mailto:programmerdeveloper@gmail.com">
                        <h1 class="lg:text-[42px] text-3xl font-bold mt-[50px] mb-3">Increva-se para receber mais informaÃ§Ãµes</h1>
            ...
            <footer>
                ...
                <div class="bottom flex justify-center gap-5 md:justify-between flex-wrap px-[5%] py-[26px]">
                    <div class="left">
                        Â© 2023 Agricultura orgÃ¢nica. - Todos os direitos reservados.
                    </div>
            </footer>
            <!--The end footer-->
            <!--The end javascript-->
