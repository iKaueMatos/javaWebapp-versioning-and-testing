...
<body class="bg-white  min-h-screen">
    ...
    <div class="container max-w-[1440px] mx-auto">
        ...
        <div class="navbar bg-white  border-spacing-1 fixed w-full top-0 max-w-[1440px]">
            <div class="container flex justify-between items-center py-3 w-full max-w-[1440px] mx-auto px-[5%]">
                ...
                <div class="right md:flex gap-8 items-center hidden " >
                    ...
                    <!-- menu-btn -->
                    <div
                        class="item btn py-3 px-6 text-sm font-medium leading-3 rounded-md text-black cursor-pointer  duration-600 hover:text-green-600"> <a href="./form.html">Cadastre seus produtos</a>
                        </div>
                </div>
                <!-- in mobile phones -->
        ...
        <div class="services">
            ...
            <div class="cards flex justify-center gap-x-7 gap-y-10 flex-wrap text-black text-center">
                <div class="card w-[370px] px-6 py-9">
                    ...
                    <p class="text-base text-justify pb-6 indent-8">Um dos maiores pontos positivos da agricultura orgânica e a produção de alimentos mais saudáveis: Ao evitar o uso de agrotóxicos
                         e fertilizantes químicos, os alimentos orgânicos são mais saudáveis e seguros para o consumo humano. </p>
                ...
                <div class="card w-[370px] px-6 py-10">
                    ...
                    <p class="text-base text-justify pb-6 indent-8">Maior teor de nutrientes: Os alimentos orgânicos são cultivados em solos mais saudáveis ​​e sem o uso de pesticidas, herbicidas ou 
                        fertilizantes sintéticos, o que pode resultar em um maior teor de nutrientes, como vitaminas, minerais e antioxidantes.</p>
                    <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                            href="#">Veja mais</a></button>
                </div>
                <div class="card w-[370px] px-7 py-10">
                    ...
                    <p class="text-base text-justify  pb-6 indent-8">Não podemos afirmar que todos os produtos convencionais são prejudiciais para os seres humanos mais a grande maioria dos produtos são processados e contém aditivos quimicos,como conservantes,
                        corante e flavorizantes artificiais. 
                    </p>
                    <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                            href="#">veja mais</a></button>
                </div>
                <div class="card w-[370px] px-6 py-9">
                    ...
                    <p class="text-base text-justify pb-6 indent-8">Os alimentos orgânicos são cultivados sem o uso de produtos químicos 
                        sintéticos, como pesticidas, herbicidas e fertilizantes, e são geralmente produzidos com práticas 
                        mais sustentáveis e respeitosas ao meio ambiente. Eles também podem conter uma quantidade maior de nutrientes e menos aditivos
                         químicos.</p>
                    <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                            href="#">veja mais</a></button>
                </div>
                <div class="card w-[370px] px-6 py-9">
                    ...
                    <p class="text-base text-justify  pb-6 indent-8">Ela define a agricultura orgânica como um sistema de produção que busca preservar a saúde do solo, das plantas, dos animais e dos seres humanos, promovendo a biodiversidade e o equilíbrio ecológico.
                    entretando um dos pontos que a lei 10.831.2003 pressupõe A proibição do uso de agrotóxicos, adubos químicos e organismos geneticamente modificados (OGMs) na produção orgânica.  
                    </p>
                    <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                            href="#">veja mais</a></button>
                </div>
        ...
        <div class="description1 grid grid-cols-1 my-40 items-center lg:grid-cols-2 justify-evenly gap-10 px-[5%]">
            ...
            <div class="right col-span-1 text-black">
                ...
                <p class="font-normal my-8 text-base text-justify indent-8">A agricultura orgânica no Brasil tem um impacto positivo em diversos aspectos, tanto ambientais quanto sociais e econômicos. Algumas das principais vantagens da agricultura orgânica no Brasil incluem:
                    ...
                    <b>5.</b> Fortalecimento da economia local: A produção de alimentos orgânicos geralmente é voltada para o mercado local, o que fortalece a economia da região e incentiva o comércio justo.<br>
                    No entanto, apesar dos benefícios da agricultura orgânica, ainda há desafios a serem enfrentados no Brasil, como a falta de incentivos governamentais e a dificuldade de acesso a crédito para os produtores orgânicos. Além disso, é importante garantir que os produtos orgânicos sejam produzidos de acordo com as normas e certificações específicas, para que possam ser comercializados de forma confiável e segura. </p>
        ...
        <div class="contact text-center my-10 mx-[5%]" id="Contato">
            <div
                class="container px-[5%] mx-auto flex flex-col max-w-[900px] w-full justify-center items-center text-black">
