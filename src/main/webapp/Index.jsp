        ...
        <div class="container max-w-[1440px] mx-auto">
                ...
                <div class="container flex justify-between items-center py-3 w-full max-w-[1440px] mx-auto px-[5%]">
                    ...
                    <div id="menu" class="fixed duration-700 w-full h-full top-0 bottom-0 right-[-100%] md w-full:md:w-1/2 bg-slate-800">
                        ...
                        <div class="item bg-green-600 mx-auto text-center w-40 btn py-3 px-6 text-sm font-medium leading-3 rounded-md text-black cursor-pointer  duration-500 hover:text-green-600">
                            <a href="./form.jsp">Cadastre seus produtos</a></div>
                    </div>
                </div>
            </div>
            <!-- home__seccion -->
            <div class="container px-[5%] my-40 grid lg:grid-cols-2 grid-cols-1 justify-between items-center" id="inicio">
                <div class="left col-span-1 text-black">
                    <h1 class="h1 mb-7">O que é a agricultura organica</h1>
                    <p class=" mb-8 indent-8 text-justify">A agricultura organica é um sistema de produção agrícola que se baseia em práticas sustentáveis e que valoriza a conservação do solo, da água, da biodiversidade e da saúde dos seres humanos e dos animais. O objetivo da agricultura
                        organica é produzir alimentos saudáveis e nutritivos, sem o uso de agrotóxicos, fertilizantes sintéticos e organismos geneticamente modificados. Na agricultura orgânica, a fertilidade do solo é mantida por meio de técnicas como
                        a adição de compostagem, rotação de culturas e uso de adubos naturais, como esterco e restos de plantas. O controle de pragas e doenças é realizado de forma integrada, por meio do uso de métodos preventivos e de controle biológico.
                        A agricultura orgânica é regulamentada por normas e certificações específicas, que visam garantir que os produtos sejam produzidos de acordo com os princípios da sustentabilidade e da saúde. Os produtos orgânicos são identificados
                        por um selo de certificação, que garante que eles foram produzidos seguindo essas normas.</p>
            ...
            <div class="services">
                ...
                <div class="cards flex justify-center gap-x-7 gap-y-10 flex-wrap text-black text-center">
                    <div class="card w-[370px] px-6 py-9">
                        <img class="pb-5 mx-auto" src="./img/AgriculturaImg/agricultores.webp" alt="Pontos positivos da Agricultura orgânica">
                        <h2 class="text-2xl font-medium pb-4">Pontos positivos da Agricultura orgânica</h2>
                        <p class="text-base text-justify pb-6 indent-8">Um dos maiores pontos positivos da agricultura orgânica e a produção de alimentos mais saudáveis: Ao evitar o uso de agrotóxicos e fertilizantes químicos, os alimentos orgânicos são mais saudáveis e seguros para o consumo humano.
                        </p>
                    ...
                    <div class="card w-[370px] px-6 py-10">
                        ...
                        <p class="text-base text-justify pb-6 indent-8">Maior teor de nutrientes: Os alimentos orgânicos são cultivados em solos mais saudáveis ​​e sem o uso de pesticidas, herbicidas ou fertilizantes sintéticos, o que pode resultar em um maior teor de nutrientes, como vitaminas, minerais
                            e antioxidantes.</p>
                        <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                                href="#">Veja mais</a></button>
                    </div>
                    <div class="card w-[370px] px-7 py-10">
                        <img class="pb-5 mx-auto" src="./img/AgriculturaImg/ProdutosOrgânicosverde.png" alt="Um alimento convecional e prejudicial para o ser humano?">
                    ...
                    <div class="card w-[370px] px-6 py-9">
                        <img class="pb-5 mx-auto" src="./img/AgriculturaImg/AgricultorFazenda.webp" alt="Qual e melhor para você alimento organico ou alimento convecional">
                        <h2 class="text-2xl font-medium pb-4">Alimentos orgânicos?</h2>
                        <p class="text-base text-justify pb-6 indent-8">Os alimentos orgânicos são cultivados sem o uso de produtos químicos sintéticos, como pesticidas, herbicidas e fertilizantes, e são geralmente produzidos com práticas mais sustentáveis e respeitosas ao meio ambiente. Eles também
                            podem conter uma quantidade maior de nutrientes e menos aditivos químicos.
                        </p>
                        <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                                href="#">veja mais</a></button>
                    </div>
                    <div class="card w-[370px] px-6 py-9">
                        <img class="pb-5 mx-auto" src="./img/AgriculturaImg/fazendeiros.webp" alt="Lei agricultura orgânica">
                        <h2 class="text-2xl font-medium pb-4">LEI 10.831.2003 Agricultura orgânica</h2>
                        <p class="text-base text-justify  pb-6 indent-8">Ela define a agricultura orgânica como um sistema de produção que busca preservar a saúde do solo, das plantas, dos animais e dos seres humanos, promovendo a biodiversidade e o equilíbrio ecológico. entretando um dos pontos que
                            a lei 10.831.2003 pressupõe A proibição do uso de agrotóxicos, adubos químicos e organismos geneticamente modificados (OGMs) na produção orgânica.
                        </p>
                        <button><a class="no-underline text-black hover:underline hover:text-green-500 duration-500"
                                href="#">veja mais</a></button>
                    </div>
            ...
            <div class="description1 grid grid-cols-1 my-40 items-center lg:grid-cols-2 justify-evenly gap-10 px-[5%]">
                ...
                <div class="right col-span-1 text-black">
                    ...
                    <p class="font-normal my-8 text-base text-justify indent-8">A agricultura orgânica no Brasil tem um impacto positivo em diversos aspectos, tanto ambientais quanto sociais e econômicos. Algumas das principais vantagens da agricultura orgânica no Brasil incluem:
                        ...
                        <b>5.</b> Fortalecimento da economia local: A produção de alimentos orgânicos geralmente é voltada para o mercado local, o que fortalece a economia da região e incentiva o comércio justo.<br> No entanto, apesar dos benefícios da
                        agricultura orgânica, ainda há desafios a serem enfrentados no Brasil, como a falta de incentivos governamentais e a dificuldade de acesso a crédito para os produtores orgânicos. Além disso, é importante garantir que os produtos
                        orgânicos sejam produzidos de acordo com as normas e certificações específicas, para que possam ser comercializados de forma confiável e segura. </p>
            ...
            <div class="description2 grid grid-cols-1 my-40 items-center lg:grid-cols-2 justify-evenly gap-10 px-[5%]">
                <div class="left col-span-1 text-black">
                    ...
                    <p class="font-normal my-8 text-base text-justify indent-8">A agricultura orgânica e a convencional são dois sistemas de produção agrícola com diferenças significativas em termos de práticas e impactos. Na agricultura convencional, os produtores utilizam agrotóxicos, fertilizantes sintéticos
                        e sementes geneticamente modificadas para aumentar a produtividade das culturas. Além disso, as monoculturas são comuns nesse sistema, o que pode levar à perda de biodiversidade e à degradação do solo. A agricultura convencional
                        também pode ter impactos negativos na saúde das pessoas e dos animais, devido ao uso excessivo de agrotóxicos. Por outro lado, a agricultura orgânica utiliza práticas sustentáveis e métodos naturais para aumentar a produtividade
                        das culturas. Os produtores orgânicos não usam agrotóxicos sintéticos ou fertilizantes químicos, e geralmente usam técnicas de compostagem, rotação de culturas e uso de adubos orgânicos para manter a fertilidade do solo. Além disso,
                        a agricultura orgânica incentiva a biodiversidade e a preservação do meio ambiente. Os alimentos orgânicos são produzidos sem o uso de agrotóxicos, o que os torna mais saudáveis e nutritivos. Além disso, a agricultura orgânica
                        pode contribuir para a criação de empregos locais e para o fortalecimento da economia regional. Em resumo, a agricultura orgânica e a convencional apresentam diferenças significativas em termos de práticas e impactos. A escolha
                        entre esses sistemas depende das prioridades e valores de cada produtor e consumidor.</p>
                    <button class="btn py-2 px-[14px] rounded">Saiba mais</button>
                </div>
            ...
            <div class="team text-center my-40">
                ...
                <div class="cards flex justify-center gap-10 flex-wrap">
                    <div class="card w-[270px] py-8 px-14 text-black text-center">
                        ...
                        <p class="font-normal leading-5 uppercase">Cursando Ciências da computação </p>
