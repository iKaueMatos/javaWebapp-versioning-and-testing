            ...
            <div class="min-h-screen flex flex-col justify-center bg-white mt-12">
                <div class="bg-white mx-auto max-w-md py-8 px-10 shadow rounded-lg">
                    ...
                    <form action="index" method="Post">
                        <div class="mb-4">
                            <input name="texto1" type="text" name="nome" placeholder="Nome" class="appearance-none block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none">
                        </div>
                        <div class="mb-4">
                            <input name="texto2" type="Text" name="regiao" placeholder="Região" class="appearance-none block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none">
                        </div>
                        <div class="mb-4">
                            <input name="texto3" type="Text"  name="valorEnergetico" placeholder="Valor energetico" class="appearance-none block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none">
                        </div>
                        <div class="mb-4">
                            <input type="Text" placeholder="Peso" name="peso" class="appearance-none block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none">
                        </div>
                        <div class="mb-4">
                            <input type="Text" placeholder="Preço" name="preco" class="appearance-none block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="nb-4">
                            ...
                            <p>
                                <a href="#" class="text-green-500">Visualizar gráfico sustentável</a>
                            </p>
                            <p> 
                                <a href="#" class="text-green-500">Ver relatório</a>
                            </p>
                        </div>
                    </form>
                </div>
